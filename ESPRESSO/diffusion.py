...
for ppp in range(0,itter):
    ...
    for i in range(0,128):
        ...
        output[counter] = espresso_function(iv_temp_c,key_temp_c,n) ^ initial_key_stream
        counter = counter + 1
...
expect = [0.00] * 5
expect[0] = 43762.00#expected(0,59,128,128)
expect[1] = 42789.00#expected(59,63,128,128)
expect[2] = 50778.00#expected(63,66,128,128)
expect[3] = 48285.00#expected(66,70,128,128)
expect[4] = 43762.00#expected(70,129,128,128)
