...
#K=100;
    ...
    for i in range(0,K):
        key[i] = os.urandom(10).encode('hex')
    
        nn = "0x" + key[i]

        iv_s = str_to_blocks("0",8)
        key_s = str_to_blocks(key[i],10)
    ...
    expect = [0.00] * 5
    expect[0] = 151578.00#expected(0,59,128,128)
    expect[1] = 227913.00#expected(59,63,128,128)
    expect[2] = 218323.00#expected(63,66,128,128)
    expect[3] = 253093.00#expected(66,70,128,128)
    expect[4] = 197669.00#expected(70,129,128,128)
